...
# print(list(filter(lambda x: 9 < abc(x) < 100, lst)))
...
# lst = [1,20, 3, 40, 5, 60, 7]
# # print(list(filter(lambda x: 9 < abc(x) < 100, lst)))
# print(list(filter(lambda x: 9 < len(int(abc(int(x=2)))) < 100, lst)))
...
# word = list(filter(lambda x: x.isalpha(), lst))  # 1 вариант
# print(word, number)

# # print(*filter(lambda x: x.isalpha(), lst))     # 2 вариант
# # print(number)
#
# # в Терминале, если 1 вариант:
# # ['a', 'b', 'c'] ['2', '3']
#
# # в Терминале, если 2 вариант:
# # a b c
# # ['2', '3']
...
#         closing = lst.index(')')
#         lst = lst[:opening] + \
#             [calculate(lst[opening + 1:closing])] + lst[closing + 1:]
#     return lst
#
#
...
# # ['(', 1.0, '+', 1.0, ')', '+', 20.0, '+', 2.0, '*', 50.0, '-', 2.0, '/', 2.0, '+',
# # '(', 5.0, '+', 5.0, ')', '+', 10.0, '-', '(', 1.0, '+', 1.0, ')']
# # [2.0, '+', 20.0, '+', 2.0, '*', 50.0, '-', 2.0, '/', 2.0, '+', 10.0, '+', 10.0, '-', 2.0]
# # 99.0
